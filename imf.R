...
DOT_counterpart <- DOT.available.codes[[4]]
...
#Financial, Intereste Rates, Government Securities, Government Bonds, Short-term, Percent per annum code is "FIGB_S_PA" in IFS
exc_code <- CodeSearch(IFS.available.codes, "CL_INDICATOR_IFS", "Exchange")
...
xdata1 <- CompactDataMethod(databaseID, queryfilterx, startdate, enddate, checkquery, tidy=TRUE) 
