...
data = read.table('data/year_origin_destination_hs07_4.tsv',
...
covid_19[which(covid_19[,'name'] == 'Iran (Islamic Republic of)'),'name'] = 'Iran'
covid_19[which(covid_19[,'name'] == 'Republic of Korea'),'name'] = 'South Korea'
...
ggplot(plot_data, aes(x = log(total_exports+1), y = ln_covid, label = country)) +
